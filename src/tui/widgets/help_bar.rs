...
fn get_help_text(app: &App) -> Vec<Span> {
    ...
    match app.focus_area {
        FocusArea::Sidebar => {
            ...
            if let Some(&(section_idx, _)) =
                sidebar_visible_items(app).get(app.sidebar_flat_selected)
            {
                match section_idx {
                    0 => spans.extend_from_slice(&[
                        Span::raw(" • "),
                        Span::styled("Public chat", Style::default().fg(Color::Cyan)),
                    ]),
                    1 => spans.extend_from_slice(&[
                        Span::raw(" • "),
                        Span::styled("Channel navigation", Style::default().fg(Color::Cyan)),
                    ]),
                    2 => spans.extend_from_slice(&[
                        Span::raw(" • "),
                        Span::styled("Direct messages", Style::default().fg(Color::Cyan)),
                    ]),
                    3 => spans.extend_from_slice(&[
                        Span::raw(" • "),
                        Span::styled("Blocked users", Style::default().fg(Color::Cyan)),
                    ]),
                    4 => spans.extend_from_slice(&[
                        Span::raw(" • "),
                        Span::styled("Settings & Nickname", Style::default().fg(Color::Cyan)),
                    ]),
                    _ => {}
                }
            }
        ...
        FocusArea::MainPanel => {
            ...
            if let Some(target) = dm_target {
                ...
                spans.extend_from_slice(&[
                    Span::raw(" • "),
                    Span::styled(format!("Channel {}", ch), Style::default().fg(Color::Cyan)),
                ]);
            }
        }
        FocusArea::InputBox => {
            if app.popup_active {
                ...
                spans.extend_from_slice(&[
                    Span::raw(" • "),
                    Span::styled("Nickname popup", Style::default().fg(Color::Cyan)),
                ]);
            } else {
                spans.extend_from_slice(&[
                    Span::styled("Tab", Style::default().fg(Color::Yellow)),
