use crate::binary_protocol_utils::{hex_decode, hex_encode, BinaryDataExt};
use crate::data_structures::{
    DeliveryAck, HandshakeRequest, NoiseIdentityAnnouncement, ProtocolAck, ProtocolNack,
    ReadReceipt, VersionAck, VersionHello,
};
